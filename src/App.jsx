...
import DebugTools from './components/Util/DebugTools';
import NavbarScript from './components/Util/NavbarScript';
import { HideUrl } from './components/Util/HideUrl';
import ScrollAni from './components/Util/ScrollAni';
import TSlider from './components/Util/TSlider';
import GetYear from './components/Util/GetYear';
import CalendlyScript from './components/Util/CalendlyScript';

function App() {

  // useEffect(() => {
  //   const script = document.createElement('script');
  //   script.innerHTML = "alert('yes')";
  //   document.body.appendChild(script);
  //   console.log("yes");
  // }, [])

  // useEffect(() => {
  //   // Assign every service-bx a different color
  //   const $ = document.querySelector;
  //   $('#tweets').style.setProperty('--clr', '#3a86ff');
  //   $('#advice').style.setProperty('--clr', '#ff006e');
  //   $('#paid-retweets').style.setProperty('--clr', '#eb5ae5');
  //   $('#giveaways').style.setProperty('--clr', '#89ec5b');
  //   $('#profile-optimization').style.setProperty('--clr', '#fdc500');
  //   $('#meetings').style.setProperty('--clr', '#e84855');

  //   // Assign the slide-row element a property based on how many slides there are
  //   let slidesAmount = 5;
  //   $('#slide-row-element').style.setProperty('--slides-num', slidesAmount);
  // }, []);
  ...
  return (
    <div className="App">
      <header id="home">
        <nav>
          ...
          <div id="nav-container">
            <ul id="nav-list">
              {/* 
              <li><a data-href="#home" onClick={openURL(this)}>Home</a></li>
              <li><a data-href="#about" onClick={openURL(this)}>About</a></li>
              <li><a data-href="#testimonials" onClick={openURL(this)}>Testimonials</a></li>
              <li><a data-href="#services" onClick={openURL(this)}>Services</a></li>
              <li><a data-href="#faq" onClick={openURL(this)}>F.A.Q</a></li>
              <li><a data-href="#call" onClick={openURL(this)}>Book a call</a></li>
            */}
        ...
        <main>
          <h1 className="hidden">CREATING YOUR X DREAM WITH UNMATCHED<br />TWEETS - THREADS - ADVICE & MORE</h1>
        </main>
      </header>
            ...
            <div className="slide-row hidden" id="slide-row-element" style={{ '--slides-num': '5'}}>
              <div className="slide-col">
                <div className="content">
                  <p>Sam's talent as a ghostwrite is unparalleled, and his contribution to my project was
                    ...
                    remarkable, and I wholeheartedly recommend his services to anyone in need of a literary
                    ally.</p>
      ...
      <section className="titled-section" id="faq">
        <h2 className="section-title hidden">F.A.Q</h2>
        <div className="faq-box">
          <div className="question hidden"><span>What happens if I don't get my wanted results?</span></div>
          <div className="answer hidden"><span>I will continue working with you for free until you get the results, then
            you can pay.</span></div>
        </div>
      </section>
      ...
      <TSlider></TSlider>
      <GetYear></GetYear>
      <CalendlyScript></CalendlyScript>


      {/* <script>console.log("yes")</script>
      <script defer="defer" src="./js/debug-tools.js"></script>
      <script defer="defer" src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.1/jquery.min.js"></script>
      <script defer="defer" src="./js/navbar.js"></script>
      <script defer="defer" src="./js/hide-url.js"></script>
      <script defer="defer" src="./js/scroll-ani.js"></script>
      <script defer="defer" src="./js/t-slider.js"></script>
      <script>document.querySelector('#year').textContent = new Date().getUTCFullYear()</script>
